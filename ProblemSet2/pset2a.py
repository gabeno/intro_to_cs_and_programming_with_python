...
balance = 4213 # 5000
annualInterestRate = 0.2 # 0.18
monthlyPaymentRate = 0.04 # 0.02
...
for i in range(1, 13):
    ...
    interest_paid = unpaid_bal * monthly_rate
    balance = unpaid_bal + interest_paid

    total_paid += monthly_payment

    print 'Month: %s' % i
    print 'Minimum monthly payment: %s' % round(monthly_payment, 2)
